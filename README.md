...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-forge-feedstock-ops-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-forge-feedstock-ops-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add conda-forge-feedstock-ops
# for installing globally
pixi global install conda-forge-feedstock-ops
```
...
It is possible to list all of the versions of `conda-forge-feedstock-ops` available on your platform:
...
```
pixi search conda-forge-feedstock-ops --channel conda-forge
```
